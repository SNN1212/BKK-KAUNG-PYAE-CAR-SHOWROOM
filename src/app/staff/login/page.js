    ...
    >
      ...
      <div className="w-full max-w-md rounded-2xl bg-white/10 backdrop-blur-md ring-1 ring-white/20 p-6 text-white">
        ...
        <form className="mt-6 space-y-4">
          ...
          <button
            type="submit"
            className="w-full rounded-lg bg-white/80 text-black font-medium py-2 hover:bg-white hover:text-red-600 cursor-pointer"
          >
            Sign in
          </button>

          <div className="text-center text-sm text-white/80">
            <Link href="/staff/forgot-password" className="hover:underline underline-offset-2">
              Forgot password?
            </Link>
          </div>
        </form>
